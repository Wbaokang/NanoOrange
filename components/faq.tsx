...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Simply upload an image and describe your desired edits in natural language. The AI understands complex instructions like 'place the person in a snowy mountain' or 'imagine the whole face and create it'. It processes your text prompt and generates perfectly edited images.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Nano Banana is optimized for speed, generating high-quality results in milliseconds to seconds. The advanced neural engine ensures ultra-fast processing without compromising on quality, making it perfect for rapid iteration and production workflows.",
  },
]
